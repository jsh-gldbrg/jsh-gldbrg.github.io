...
lib.ssMetadata = [
		{name:"forrent_gym_300x600_atlas_P_", frames: [[352,0,212,253],[352,505,211,132],[352,255,209,248],[563,255,193,122],[0,0,350,814]]}
];
...
(lib.gym_background = function() {
	this.initialize(img.gym_background);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1382,922);


(lib.left_arm = function() {
	this.spriteSheet = ss["forrent_gym_300x600_atlas_P_"];
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.left_bicep = function() {
	this.spriteSheet = ss["forrent_gym_300x600_atlas_P_"];
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
...
(lib.m_torso = function(mode,startPosition,loop) {
...
}).prototype = getMCSymbolPrototype(lib.m_torso, new cjs.Rectangle(0,0,350,814), null);


(lib.m_rightbicep = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.instance = new lib.right_bicep();
	this.instance.parent = this;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.m_rightbicep, new cjs.Rectangle(0,0,193,122), null);


(lib.m_rightarm = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
}).prototype = getMCSymbolPrototype(lib.m_rightarm, new cjs.Rectangle(0,0,209,248), null);
...
(lib.m_name = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#FFFFFF").s().p("AA+DBIiZkXIgDAAIAADgIAjADIAAA0Ih8AAIAAg0IAegDIAAkSIgegEIAAg0ICeAAIB3DoIACAAIAAiwIgggEIAAg0IB4AAIAAA0IgdAEIAAFJg");
	this.shape.setTransform(147.6,32);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AAHDBIAAg0IAkgEIgPgwIhtAAIgOAwIAiAEIAAA0IiGAAIAAg0IAggEIB3lJIBdAAIBxFJIAiAEIAAA0gAAPAoIgkiDIgBAAIgsCDIBRAAg");
	this.shape_1.setTransform(108.2,32);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AheDBIAAg1IAugDIAAhrIhgimIgfgDIAAg1IC2AAIAAA1IghADIA3BsIA5hsIghgDIAAg1IB7AAIAAA1IgeADIhaCmIAABrIAtADIAAA1g");
	this.shape_2.setTransform(76.1,32);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(44.1,32.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	// block
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#1A7ABA").s().p("AuDFAIAAp/IcHAAIAAJ/g");
	this.shape_4.setTransform(90,32);

	this.timeline.addTween(cjs.Tween.get(this.shape_4).wait(1));

}).prototype = getMCSymbolPrototype(lib.m_name, new cjs.Rectangle(0,0,199,68.6), null);
...
(lib.m_leftbicep = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.instance = new lib.left_bicep();
	this.instance.parent = this;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.m_leftbicep, new cjs.Rectangle(0,0,211,132), null);


(lib.m_leftarm = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
}).prototype = getMCSymbolPrototype(lib.m_leftarm, new cjs.Rectangle(0,0,212,253), null);
...
(lib.m_ctadarkbox = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#EC7200").s().dr(-14.5,-26.5,29,53);
...
(lib.m_ctabase = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#EE8726").s().dr(-98.5,-26.5,197,53);
...
(lib.m_copy = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(158.5,36.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgVArIAAhUIAMAAIACASQABgFADgEIAEgFIAGgEIAIgBIAIAAIgDAPIgHgBQgFAAgCACIgGAEIgDAHIgEALIAAAvg");
	this.shape_1.setTransform(154.2,33.4);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("");
	this.shape_2.setTransform(146,33.5);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgJApQgGgDgFgFQgFgGgDgIQgCgJAAgKQAAgJACgIQADgIAFgGQAFgGAGgDQAHgDAIAAQAHAAAGACQAHACAFAFIgHAJIgIgEQgEgCgGAAQgFAAgDACQgEACgCAEQgDAEgCAGQgBAGAAAHQAAAIABAHQACAFADAEQACAEAEABQADADAFAAQAFAAAFgDIAIgEIAHAJQgFAFgHADQgGACgHAAQgIAAgHgDg");
	this.shape_3.setTransform(138.1,33.5);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("");
	this.shape_4.setTransform(126.1,33.5);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AgHA+IAAhTIAPAAIAABTgAgHgsQgCgDAAgEQAAgEACgDQADgDAEgBQAFABADADQACADAAAEQAAAEgCADQgDADgFAAQgEAAgDgDg");
	this.shape_5.setTransform(120.2,31.4);
	...
	this.shape_6.setTransform(113.3,31.7);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AAAA0QgDgBgDgDQgEgEgBgEQgCgFABgFIAAgzIgPAAIAAgLIAPAAIAAgTIAOgBIAAAUIAUAAIgCALIgSAAIAAAyQAAAHACACQACAEAGgBQAEAAAHgDIAFAKQgEADgEABIgLACQgFAAgEgCg");
	this.shape_7.setTransform(101.6,32.5);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("");
	this.shape_8.setTransform(94,33.5);
	...
	this.shape_9.setTransform(84.7,33.4);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AgLAYIAHgaQgFgEAAgFQAAgFADgDQADgDAEAAQAFAAADADQADADAAAFQAAAEgCAHIgLAYg");
	this.shape_10.setTransform(73.8,38);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AgWArIAAhUIAOAAIABASQACgFACgEIAEgFIAGgEIAHgBIAIAAIgCAPIgIgBQgDAAgEACIgFAEIgEAHIgDALIAAAvg");
	this.shape_11.setTransform(69.6,33.4);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("");
	this.shape_12.setTransform(61.2,33.5);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AAAA0QgDgBgDgDQgDgEgCgEQgBgFgBgFIAAgzIgOAAIAAgLIAOAAIAAgTIAPgBIAAAUIATAAIgBALIgSAAIAAAyQAAAHABACQADAEAFgBQAFAAAGgDIAGAKQgEADgEABIgKACQgGAAgEgCg");
	this.shape_13.setTransform(53.8,32.5);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("");
	this.shape_14.setTransform(46.4,33.5);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AgIAqIgdhTIAQAAIAVBGIAWhGIAQAAIgdBTg");
	this.shape_15.setTransform(38.2,33.4);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("");
	this.shape_16.setTransform(29.9,33.5);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("AgEA8QgDgCgCgCQgDgCgBgDIgBgIIAAhlIAOgCIAABmQAAAEACABQAAAAAAABQAAAAABAAQAAABABAAQABAAAAAAIAGgBIADAKQgGADgGAAQgDAAgDgBg");
	this.shape_17.setTransform(23.7,31.8);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFFFFF").s().p("");
	this.shape_18.setTransform(16.4,33.5);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("");
	this.shape_19.setTransform(165.5,14.8);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FFFFFF").s().p("AARA8IAAg7IgBgGIgCgGQgEgDgGAAQgGAAgFAEQgFAEgEAGIAAA8IgPAAIAAh1IAPgCIAAAvQAEgGAGgEQAGgDAIAAQAFAAAFABIAIAFQADAEABAFQACAEAAAGIAAA8g");
	this.shape_20.setTransform(156.4,13);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFFFFF").s().p("AAAA0QgEgBgDgDQgDgEgBgEQgCgFAAgFIAAgzIgOAAIAAgLIAOAAIAAgTIAOgCIAAAVIAUAAIgBALIgTAAIAAAyQAAAHACACQADADAFABQAGAAAFgEIAGAKQgEADgFABIgKABQgFAAgEgBg");
	this.shape_21.setTransform(148.9,13.9);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#FFFFFF").s().p("AARArIAAg6IAAgHQgBgDgCgCQgDgEgHAAQgGAAgFAFQgFADgEAHIAAA7IgPAAIAAhUIANAAIABANQAEgGAHgFIAGgCIAIgBQAFAAAFABQAFADADADQADADABAFQACAFAAAGIAAA7g");
	this.shape_22.setTransform(137.1,14.7);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#FFFFFF").s().p("AgGA+IAAhTIANAAIAABTgAgGgsQgDgDgBgEQABgEADgDQADgEADAAQAEAAADAEQAEADAAAEQAAAEgEADQgDACgEAAQgDAAgDgCg");
	this.shape_23.setTransform(130.2,12.8);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#FFFFFF").s().p("AAnArIAAg6IgBgHIgCgFQgDgEgGAAQgGAAgFAFQgDADgFAHIAAA7IgOAAIAAg6IgBgHQgBgDgCgCQgDgEgFAAQgGAAgFAFQgEADgFAHIAAA7IgPAAIAAhUIANAAIABANQAFgGAFgFIAHgCIAIgBIAHABIAGACIAEAGIADAGQAFgHAGgEIAGgDIAIgBQAFAAAEABQAFADADADQADADABAFQACAFAAAGIAAA7g");
	this.shape_24.setTransform(116.9,14.7);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#FFFFFF").s().p("AgeAwIALgDQAEgCADgDQAEgDAFgMIgFAAIgdhTIAQAAIAWBJIAWhJIAPAAIgcBUIgGAMQgDAGgDAEQgFAFgGACQgHADgIABg");
	this.shape_25.setTransform(106.1,16.5);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#FFFFFF").s().p("");
	this.shape_26.setTransform(98.2,16);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#FFFFFF").s().p("");
	this.shape_27.setTransform(85.3,14.8);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#FFFFFF").s().p("AARA8IAAg7IgBgGIgCgGQgEgDgGAAQgGAAgFAEQgFAEgEAGIAAA8IgPAAIAAh1IAPgCIAAAvQAEgGAGgEQAGgDAIAAQAFAAAFABIAIAFQADAEABAFQACAEAAAGIAAA8g");
	this.shape_28.setTransform(76.2,13);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#FFFFFF").s().p("AAAA0QgEgBgDgDQgCgEgCgEQgCgFAAgFIAAgzIgOAAIAAgLIAOAAIAAgTIAOgCIAAAVIAUAAIgBALIgTAAIAAAyQAAAHACACQADADAFABQAFAAAGgEIAGAKQgEADgEABIgKABQgGAAgEgBg");
	this.shape_29.setTransform(68.7,13.9);
	...
	this.shape_30.setTransform(56.9,14.8);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f("#FFFFFF").s().p("AAAA0QgEgBgDgDQgDgEgBgEQgCgFAAgFIAAgzIgOAAIAAgLIAOAAIAAgTIAOgCIAAAVIAUAAIgBALIgTAAIAAAyQAAAHACACQADADAFABQAGAAAFgEIAGAKQgEADgFABIgKABQgFAAgEgBg");
	this.shape_31.setTransform(49.5,13.9);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f("#FFFFFF").s().p("");
	this.shape_32.setTransform(38.5,14.8);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f("#FFFFFF").s().p("AAAA0QgDgBgDgDQgDgEgCgEQgBgFgBgFIAAgzIgOAAIAAgLIAOAAIAAgTIAPgCIAAAVIAUAAIgCALIgSAAIAAAyQAAAHABACQADADAGABQAFAAAFgEIAGAKQgEADgEABIgKABQgGAAgEgBg");
	this.shape_33.setTransform(32.1,13.9);

	this.shape_34 = new cjs.Shape();
	this.shape_34.graphics.f("#FFFFFF").s().p("");
	this.shape_34.setTransform(24.7,14.8);

	this.shape_35 = new cjs.Shape();
	this.shape_35.graphics.f("#FFFFFF").s().p("");
	this.shape_35.setTransform(16.4,16);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_35},{t:this.shape_34},{t:this.shape_33},{t:this.shape_32},{t:this.shape_31},{t:this.shape_30},{t:this.shape_29},{t:this.shape_28},{t:this.shape_27},{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	// box
	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f("#E4089D").s().p("AtbBuIAAjbIa3AAIAADbg");
	this.shape_36.setTransform(86,37);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f("#E4089D").s().p("AucCHIAAkNIc5AAIAAENg");
	this.shape_37.setTransform(92.5,13.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_37},{t:this.shape_36}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.m_copy, new cjs.Rectangle(0,0,192,48), null);


(lib.m_bg = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.instance = new lib.gym_background();
	this.instance.parent = this;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.m_bg, new cjs.Rectangle(0,0,1382,922), null);
...
(lib.m_animation = function(mode,startPosition,loop) {
	...
	// left bicep
	this.instance = new lib.m_leftbicep();
	this.instance.parent = this;
	this.instance.setTransform(193.2,165,0.65,0.65,0,0,0,211,66.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:211.2,regY:66.2,rotation:20,x:193.3},24).to({regX:211,regY:66.1,rotation:0,x:193.2},25,cjs.Ease.get(0.5)).wait(16));

	// right bicep
	this.instance_1 = new lib.m_rightbicep();
	this.instance_1.parent = this;
	this.instance_1.setTransform(290.1,161.7,0.65,0.65,0,0,0,0.1,61);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regX:0.2,regY:61.1,scaleX:0.65,scaleY:0.65,rotation:-20,x:290},24).to({regX:0.1,regY:61,scaleX:0.65,scaleY:0.65,rotation:0,x:290.1},25,cjs.Ease.get(0.5)).wait(16));

	// lef arm
	this.instance_2 = new lib.m_leftarm();
	this.instance_2.parent = this;
	this.instance_2.setTransform(68.9,207.5,0.65,0.65,0,0,0,106,253.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({regY:253.6,rotation:3,y:167.6},24).to({regY:253.1,rotation:0,y:207.5},25,cjs.Ease.get(0.5)).wait(16));

	// right arm
	this.instance_3 = new lib.m_rightarm();
	this.instance_3.parent = this;
	this.instance_3.setTransform(392.9,201.2,0.65,0.65,0,0,0,104.5,248);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({regX:104.7,regY:247.9,rotation:-3,y:161.2},24).to({regX:104.5,regY:248,rotation:0,y:201.2},25,cjs.Ease.get(0.5)).wait(16));

	// torso
	this.instance_4 = new lib.m_torso();
	this.instance_4.parent = this;
	this.instance_4.setTransform(240.8,264.6,0.65,0.65,0,0,0,175,407);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(65));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,460.9,529.1);


// stage content:
(lib.forrent_gym_300x600 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.cta_mc.setTransform(153.1,459,1.1,1.1,0,0,0,101,29.1);

	this.timeline.addTween(cjs.Tween.get(this.cta_mc).wait(1));

	// name
	this.instance = new lib.m_name();
	this.instance.parent = this;
	...
	// copy
	this.instance_1 = new lib.m_copy();
	this.instance_1.parent = this;
	this.instance_1.setTransform(160.5,317.7,1,1,0,0,0,95.5,22.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	// logo
	this.instance_2 = new lib.m_logo();
	this.instance_2.parent = this;
	this.instance_2.setTransform(150,44.8,1,1,0,0,0,115,14.8);
	this.instance_2.cache(-2,-2,234,34);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1));

	// animation
	this.animation_mc = new lib.m_animation();
	this.animation_mc.parent = this;
	this.animation_mc.setTransform(143.4,343.6,1,1,0,0,0,230.4,264.6);

	this.timeline.addTween(cjs.Tween.get(this.animation_mc).wait(1));

	// bg
	this.instance_3 = new lib.m_bg();
	this.instance_3.parent = this;
	this.instance_3.setTransform(150,300.2,0.651,0.651,0,0,0,690.9,461.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-150,299.8,900,608.3);
// library properties:
lib.properties = {
	width: 300,
	height: 600,
	...
	opacity: 1.00,
	manifest: [
		{src:"gym_background.jpg?1486572623153", id:"gym_background"},
		{src:"forrent_gym_300x600_atlas_P_.png?1486572623117", id:"forrent_gym_300x600_atlas_P_"}
	],
	preloads: []
};
